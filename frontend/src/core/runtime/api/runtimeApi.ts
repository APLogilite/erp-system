 ...
 * Optionally pass parent record context for server-side filter_where_clause resolution.
 * GET /api/v1/runtime/windows/lookup/{tableName}?parentRecordId=...&tabId=...&fieldCode=...
 */
