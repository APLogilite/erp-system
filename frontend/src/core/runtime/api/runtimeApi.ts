 ...
 * windowId = current window (to resolve @tab.field@ placeholders by tab name)
 * GET /api/v1/runtime/windows/lookup/{tableName}?parentRecordId=...&tabId=...&windowId=...&fieldCode=...
 */
