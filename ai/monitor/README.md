...
|--------|------|----------|
| Project Board | `ai/PROJECT_BOARD.md` | Swimlanes, PRD status, stats |
| Tasks | `ai/tasks/*.md` | Individual task frontmatter (status, owner, priority, PRD, hours) |
| Changes | `ai/changes/*.md` | Change report metadata (developer, duration) |
| PRDs | `ai/prd/*.md` | PRD metadata (version, status, task count) |
