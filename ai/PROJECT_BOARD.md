...
|------|-----|----------|-------|--------|
| TASK-038 | PRD-004 | Critical | software_engineer | feature/TASK-038 |
...
| Ready For Test | 2 (TASK-036, TASK-037) |
| In Development | 1 (TASK-038) |
| In Testing | 0 |
...
| Total Tasks | 37 completed + 2 ready-for-test + 2 ready-for-dev + 7 planned + 6 bugs |
