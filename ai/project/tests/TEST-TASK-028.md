...
- `ai/project/scripts/verify-prd-003-data.sql` — PostgreSQL data verification for all PRD-003 migrations (V19-V23)
- Run via `ai/project/scripts/run-all-regression.sh` — includes PRD-003 checks
