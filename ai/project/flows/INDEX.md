...
> Auto-maintained by Technical Writer. Update this file when creating, updating, or deleting flow documents.
...
| File | Description |
|------|-------------|
| `delete-record.md` | Soft-delete confirmation → execution |
