...
change_summary: ai/project/changes/CHANGE-TASK-005.md

test_report: ai/project/tests/TEST-TASK-005.md
...
history:
  ...
  - 2026-07-09 — QA Engineer verified; all 3 methods present; status: READY_FOR_TEST → TESTED
