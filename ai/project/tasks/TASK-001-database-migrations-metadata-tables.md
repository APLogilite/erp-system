...
change_summary: ai/project/changes/CHANGE-TASK-001.md

test_report: ai/project/tests/TEST-TASK-001.md
test_script: ai/project/scripts/verify-prd-001-schema.sql
