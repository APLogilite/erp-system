...
|-------|------|----------------|
| 1 | `ai/agent/rules/workflow.md` | This file — master overview |
| 2 | `ai/agent/project-memory.md` | Project context and conventions |
| 3 | `ai/agent/rules/status-transitions.md` | All statuses, transitions, lock rules, cascade |
| 4 | `ai/agent/rules/communication.md` | Principles, escalation, blocker reporting |
| 5 | `ai/agent/rules/execution.md` | Startup, continuous execution, stopping, reporting |
| 6 | `ai/agent/rules/documentation.md` | File ownership, sync rules, templates |
| 7 | `ai/agent/rules/git-workflow.md` (SE + QA only) | Branches, lock-before-branch, merge rules |
...
→ See `ai/agent/rules/status-transitions.md` for full transition rules per status.
...
→ See `ai/agent/rules/git-workflow.md` for lock-before-branch rules, merge rules, and commit conventions.
...
| Directory | Owner |
|-----------|-------|
| `ai/project/prd/`, `ai/project/tasks/` | Product Manager |
| `ai/agent/`, `ai/agent/project-board.md`, `ai/agent/changelog.md` | Product Manager |
| `backend/`, `frontend/` | Software Engineer |
| `ai/project/changes/` | Software Engineer |
| `ai/project/tests/`, `ai/project/scripts/` | QA Engineer |
| `ai/project/modules/`, `ai/project/flows/` | Technical Writer |

→ See `ai/agent/rules/documentation.md` for full ownership and sync rules.
