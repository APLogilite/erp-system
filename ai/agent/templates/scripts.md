...
-- Usage: psql -U erp_user -h localhost -d erp_db -f ai/project/scripts/<script-name>.sql
-- ============================================================
...
-- Check against canonical DDL in ai/project/schema/<table>.sql
-- Never hardcode column names that duplicate what's in ai/project/schema/
...
# Usage: ./ai/project/scripts/<script-name>.sh
# ============================================================
...
1. **Reference `ai/project/schema/`** for expected table structure — do not hardcode column lists
