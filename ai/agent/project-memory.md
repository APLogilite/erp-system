...
| Current Phase | PRD-005 — COMPLETED (2026-07-30) / Next: PRD-006 Sales Quotation & Price Management |
...
Tasks may require changes across frontend, backend, database, or all three. Every task's `scope:` field (in frontmatter) indicates which layers are affected. Always verify ALL scope layers before completing implementation. After schema changes, update the corresponding DDL file in `ai/project/schema/`.
