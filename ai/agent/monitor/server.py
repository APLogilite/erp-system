...
TASKS_DIR = os.path.join(AI_DIR, "project", "tasks")
CHANGES_DIR = os.path.join(AI_DIR, "project", "changes")
PRD_DIR = os.path.join(AI_DIR, "project", "prd")
BOARD_FILE = os.path.join(AI_DIR, "agent", "project-board.md")
