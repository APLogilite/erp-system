...
--   1. admin_table_column — Tables + child Columns
--   2. admin_window_tab_field — Windows + child Tabs + child Fields + Access
--   3. admin_menu — Menu configuration
--
...
SELECT ensure_field('admin_table_column', 10, 'name',         10, false, true, false, true);
SELECT ensure_field('admin_table_column', 10, 'label',        20, false, true, false, true);
SELECT ensure_field('admin_table_column', 10, 'plural_label', 30, false, true, false, false);
SELECT ensure_field('admin_table_column', 10, 'table_type',   40, false, true, false, true);
SELECT ensure_field('admin_table_column', 10, 'table_name',   50, false, true, false, true);
SELECT ensure_field('admin_table_column', 10, 'description',  60, false, true, false, false);

-- Columns tab (seq 20) — sys_column fields
SELECT ensure_field('admin_table_column', 20, 'code',          10, false, true, false, true);
SELECT ensure_field('admin_table_column', 20, 'label',         20, false, true, false, true);
SELECT ensure_field('admin_table_column', 20, 'type',          30, false, true, false, true);
SELECT ensure_field('admin_table_column', 20, 'required',      40, true,  true, false, false);
SELECT ensure_field('admin_table_column', 20, 'max_length',    50, false, true, false, false);
SELECT ensure_field('admin_table_column', 20, 'precision',     60, true,  true, false, false);
SELECT ensure_field('admin_table_column', 20, 'scale',         70, true,  true, false, false);
SELECT ensure_field('admin_table_column', 20, 'relation_table',80, false, true, false, false);
SELECT ensure_field('admin_table_column', 20, 'enum_options',  90, false, true, false, false);
SELECT ensure_field('admin_table_column', 20, 'position',      100, false, true, false, false);

-- Window 2: Window, Tab, Field & Access
-- Windows tab (seq 10) — sys_window fields
SELECT ensure_field('admin_window_tab_field', 10, 'name',        10, false, true, false, true);
SELECT ensure_field('admin_window_tab_field', 10, 'description', 20, false, true, false, false);

-- Tabs tab (seq 20) — sys_tab fields
SELECT ensure_field('admin_window_tab_field', 20, 'name',          10, false, true, false, true);
SELECT ensure_field('admin_window_tab_field', 20, 'seq_no',        20, true,  true, false, true);
SELECT ensure_field('admin_window_tab_field', 20, 'is_single_row', 30, true,  true, false, false);
SELECT ensure_field('admin_window_tab_field', 20, 'where_clause',  40, false, true, false, false);
SELECT ensure_field('admin_window_tab_field', 20, 'parent_column', 50, false, true, false, false);

-- Fields tab (seq 30) — sys_window_field fields
SELECT ensure_field('admin_window_tab_field', 30, 'seq_no',        10, false, true, false, true);
SELECT ensure_field('admin_window_tab_field', 30, 'is_same_line',  20, true,  true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'num_lines',     30, true,  true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'column_width',  40, true,  true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'is_displayed',  50, true,  true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'is_readonly',   60, true,  true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'is_mandatory',  70, true,  true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'display_logic', 80, false, true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'readonly_logic',90, false, true, false, false);
SELECT ensure_field('admin_window_tab_field', 30, 'label_override',100, false, true, false, false);

-- Access tab (seq 40) — sys_window_access fields
SELECT ensure_field('admin_window_tab_field', 40, 'role_id',   10, false, true, false, true);
SELECT ensure_field('admin_window_tab_field', 40, 'tenant_id', 20, false, true, false, false);

-- Window 3: Menu
-- Menu tab (seq 10) — sys_menu fields
SELECT ensure_field('admin_menu_config', 10, 'name',      10, false, true, false, true);
SELECT ensure_field('admin_menu_config', 10, 'type',      20, false, true, false, true);
SELECT ensure_field('admin_menu_config', 10, 'seq_no',    30, true,  true, false, true);
SELECT ensure_field('admin_menu_config', 10, 'icon',      40, false, true, false, false);
